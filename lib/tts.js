...
const voices = [
	'br_003', 'br_004', 'br_005', 'de_001', 'de_002', 'en_au_001',
	'en_au_002', 'en_female_betty', 'en_female_emotional',
	'en_female_grandma', 'en_female_madam_leota', 'en_female_makeup',
	'en_female_pansino', 'en_female_richgirl', 'en_female_samc',
	'en_female_shenna', 'en_male_ashmagic', 'en_male_cody',
	'en_male_cupid', 'en_male_deadpool', 'en_male_funny',
	'en_male_ghosthost', 'en_male_grinch', 'en_male_jarvis',
	'en_male_jomboy', 'en_male_narration', 'en_male_olantekkers',
	'en_male_pirate', 'en_male_santa_effect', 'en_male_santa_narration',
	'en_male_trevor', 'en_male_ukbutler', 'en_male_ukneighbor',
	'en_male_wizard', 'en_uk_001', 'en_us_002', 'en_us_006',
	'en_us_007', 'en_us_009', 'en_us_010', 'en_us_c3po',
	'en_us_chewbacca', 'en_us_ghostface', 'en_us_ghostface',
	'en_us_rocket', 'en_us_stitch', 'en_us_stormtrooper', 'es_002',
	'es_mx_002', 'es_mx_002', 'fr_001', 'fr_002', 'id_001',
	'pt_female_laizza', 'pt_female_lhays',
...
const singing_voices = [
	'en_male_m03_classical', 'en_male_m03_lobby',
	'en_male_m03_sunshine_soon', 'en_male_m2_xhxs_m03_christmas',
	'en_male_m2_xhxs_m03_silly', 'en_male_sing_deep_jingle',
...
const all_singing_voices = [
	'en_female_f08_salut_damour', 'en_female_ht_f08_halloween',
	'en_male_m03_classical', 'en_male_m03_lobby',
	'en_male_m03_sunshine_soon', 'en_male_m2_xhxs_m03_christmas',
	'en_male_m2_xhxs_m03_silly', 'en_male_sing_deep_jingle',
	'en_male_sing_funny_thanksgiving',
 ...
 * @param {string} voice
 *
 * @return {string} Returns the same filename on success; an empty string on failure
 */
async function ttsToMP3(string, filename, voice = undefined) {
	if(voice === 'tts')
		voice = getRandomVoice();
	else if(voice === 'ttsing')
		voice = getRandomSingingVoice();

	let voice_number = voices.findIndex( (e) => e === voice);
	if(voice_number === -1)
		voice_number = all_singing_voices.findIndex( (e) => e === voice);
