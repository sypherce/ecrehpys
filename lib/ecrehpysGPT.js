 ...
 * The response is generated using the OpenAI GPT-3.5 Turbo model by default.
 *
 ...
 */
async function generateResponse(user, userInput, header, trackHistory, cacheInput, temperature = 1, model = 'gpt-3.5-turbo') {
	...
	// Debug output
	log.debug(`Tokens used: ${completion.usage.total_tokens}`);
