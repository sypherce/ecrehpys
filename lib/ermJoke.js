...
async function getJoke() {
	try {
		...
		log.debug(joke);
		ja.append(joke, 'config/jokes.json');
		return joke;
	} catch (err) {
		log.error(err);
		return '';
...
/**
 * Retrieves a joke, translates it to ermahgerd speak, and returns the translated joke.
 * @return {Promise<string>} The translated joke string.
 */
